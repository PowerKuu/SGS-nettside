...
export default () => {
    return <div class={styles.solutions}>
        <Solution heading={<><span>Web</span> utvikling</>} image={webDevelopmentImage}>
            ...
            Med vårt fokus på brukeropplevelse og søkemotoroptimalisering kan vi hjelpe nettstedet ditt med å tiltrekke og beholde besøkende, generere mer trafikk og øke salget på nett. Velg SGS Markedsføring for responsive og kreativ webutvikling.
            </SolutionContent>

            <SolutionContent heading="Merkevare" icon={brandingVector}>
            Som et fullservice selskap for webdesign og digital markedsføring, kan SGS Markedsføring hjelpe deg med å skape din merkevare fra grunnen av. Enten du er en oppstart eller en etablert bedrift, har vi ekspertisen og erfaringen til å hjelpe deg med å definere merkevaren din og bringe den til live gjennom overbevisende bilder og meldinger.
            </SolutionContent>
        </Solution>
        ...
        <Solution heading={<><span>Markeds</span>føring</>} image={webDevelopmentImage}>
            ...
            Markedsføring på sosiale medier er en nøkkelkomponent i enhver digital markedsføringsstrategi, og SGS Markedsføring har ekspertisen og erfaringen til å hjelpe deg å få mest mulig ut av den. Vi kan hjelpe deg med å utvikle en markedsføringsplan for sosiale medier som er i tråd med forretningsmålene dine og retter seg mot den rette målgruppen.
            </SolutionContent>
